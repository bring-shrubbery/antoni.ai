...
const Scrollbar: React.FC<ScrollbarProps> = ({
  ...
  return (
    <div style={inlineStyle}>
      <div
        ref={trackRef}
        className="w-full h-0.5 rounded-xs bg-muted-foreground overflow-hidden relative translate-x-0"
      >
        <div
          className="min-w-[50px] h-full absolute bg-primary rounded-xs left-0"
          style={{
            width: barWidth * 100 + "%",
            transform:
