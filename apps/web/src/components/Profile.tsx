...
const StarToggle = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "size-7 flex items-center justify-center text-border ml-[3px] mr-[0.25px] hover:bg-muted hover:text-orange-400 rounded-sm transition-all duration-75",
